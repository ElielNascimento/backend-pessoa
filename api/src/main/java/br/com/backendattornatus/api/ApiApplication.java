...
public class ApiApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		PessoaModel p1 = new PessoaModel(null,"Eliel Nascimento", "44775142046", "nascimento.eliel@gmail.com",
				LocalDate.of(1992, 8, 6));
		PessoaModel p2 = new PessoaModel(null,"Pedro Nascimento", "53614771415", "pedro@gmail.com",
				LocalDate.of(2005, 8, 4));
		pessoaRepository.saveAll(Arrays.asList(p1, p2));

		EnderecoModel end1 = new EnderecoModel("Av dos Palmares", 722, "Maringa", Enums.PRINCIPAL);
		EnderecoModel end2 = new EnderecoModel("Rua cuiába", 1075, "São Paulo",Enums.NAO_PRINCIPAL );
		EnderecoModel end3 = new EnderecoModel("Rua floripa", 075, "Santa catarina",Enums.NAO_PRINCIPAL);
